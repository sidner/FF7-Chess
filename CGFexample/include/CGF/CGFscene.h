...
/// This class stores information on one 3D scene, including cameras, lights and objects.
{
	...
	protected:
		void setUpdatePeriod(long millis);		///< Sets the update period between each call to update(), in milliseconds. if millis=0, updates are disabled.
